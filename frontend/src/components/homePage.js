...
const WEBPDFizerHomePage = () => {
    ...
    return (
        <div className='mt-5' >
            ...
            <div style={{ position: 'relative', height: '400px', marginTop: '15px' }}>
                ...
                >
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '3.5fr 0.5fr', textAlign: 'center', marginTop: '20px' }}>
                        ...
                        />
                        <button className="btn -ml-8 btn-error" style={{ borderRadius: '40px' }} onClick={() => onSaveAsPdfClickBtnClick()}>save as pdf</button>
                            ...
                            {progressData !== null && progressData.length > 0 && progressData.map((item, index) => (
                                <tr key={item.id} className="hover">
                                    ...
                                    <td className='flex justify-center gap-20'>
                                        <FaEye className='mx-2' onClick={() => { onViewBtnClick(item.id) }} />
                                        {item.status === 'completed' ? (
                                            <BsDownload className='mx-2' onClick={() => { onDownloadBtnClick(item.id) }} />
                                        ) : (
            ...
            <div></div>
            <footer className="footer items-center p-4 bg-neutral text-neutral-content mt-14">
